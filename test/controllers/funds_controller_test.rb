...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference("Fund.count") do
      post funds_url, params: { fund: { amc_name: @fund.amc_name, fund_name: @fund.fund_name } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { amc_name: @fund.amc_name, fund_name: @fund.fund_name } }
